...
#| echo: false
#| include: false
df <- subset(df.raw, select=c(trial_index, subject_id, matrix_size, transition_matrix, sequence, conditional_entropies, trials_per_block, total_trials, practice_trials, phase, block, experiment_trial_type, trial_in_block, overall_trial, position, correct_key, response, correct, rt, conditional_entropy, surprisal, questionnaire_item)) %>%
